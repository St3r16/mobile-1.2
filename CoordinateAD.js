class CoordinateAD {
    ...
    static midCor(obj1, obj2) {
      if (obj1.dir != obj2.dir) {
        ...
        return new CoordinateAD(midDeg, midMin, midSec, newDir);
      }
    }
...
let cord = new CoordinateAD(-22, 25, 54, 0);
let cord1 = new CoordinateAD (22, 25, 54, 0);
console.log("Метод, що повертає рядок з градусами, мін, сек:\n", cord.stringer());
console.log("Метод, що повертає рядок з десятковим знач координати:\n",cord.decimal());
console.log(cord); //Заданий набор значень
console.dir(cord.middleCor(-17, 40, 50, 0)); // Середні коорд між поточним та вхідними параметрами
console.log(CoordinateAD.midCor(cord,cord1)); //Середні коорд між двома обьектами
